...
headers = ["Mturk_ID", "cohort", "training1_success", "training1_time", "training1_dist_C", "training1_dist_E", "training1_dist_F", "training1_dist_L", "training1_dist_M", "training1_dist_N", "training1_dist_O", "training1_dist_T", "training1_sum_distance",
...
def arrange_csv(data):
   ...
   table.to_csv("processedData.csv", header = False, index = False)
